...
import com.trazadera.golden.restclient.model.GoldenNotificationRequestDto;
import com.trazadera.golden.restclient.model.GoldenNotificationResponseDto;
...
public class GoldenApi {
     ...
     * @param physical Physical delete flag. (optional, default to false)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteBucketCall(String entity, String bucket, Boolean physical, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        if (physical != null)
        localVarQueryParams.addAll(apiClient.parameterToPair("physical", physical));
    ...
    private com.squareup.okhttp.Call deleteBucketValidateBeforeCall(String entity, String bucket, Boolean physical, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteBucketCall(entity, bucket, physical, progressListener, progressRequestListener);
        return call;
     ...
     */
    public BaseResponseDto deleteBucket(String entity, String bucket, Boolean physical) throws ApiException {
        ApiResponse<BaseResponseDto> resp = deleteBucketWithHttpInfo(entity, bucket, physical);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<BaseResponseDto> deleteBucketWithHttpInfo(String entity, String bucket, Boolean physical) throws ApiException {
        com.squareup.okhttp.Call call = deleteBucketValidateBeforeCall(entity, bucket, physical, null, null);
     ...
     */
    public com.squareup.okhttp.Call deleteBucketAsync(String entity, String bucket, Boolean physical, final ApiCallback<BaseResponseDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteBucketValidateBeforeCall(entity, bucket, physical, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<BaseResponseDto>(){}.getType();
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call deleteRecordCall(String entity, String record, Boolean physical, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call deleteRecordValidateBeforeCall(String entity, String record, Boolean physical, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'entity' is set
        if (entity == null) {
        ...
        com.squareup.okhttp.Call call = deleteRecordCall(entity, record, physical, progressListener, progressRequestListener);
        return call;
     ...
     * Locates a golden record by identifier into indicated entity and deletes. If the entity has a history, the record is not deleted but but moved to history.
     * @param entity Entity identifier (required)
     * @param record Record identifier (required)
     * @param physical Physical delete flag. (optional, default to false)
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GoldenDeleteResponseDto deleteRecord(String entity, String record, Boolean physical) throws ApiException {
        ApiResponse<GoldenDeleteResponseDto> resp = deleteRecordWithHttpInfo(entity, record, physical);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GoldenDeleteResponseDto> deleteRecordWithHttpInfo(String entity, String record, Boolean physical) throws ApiException {
        com.squareup.okhttp.Call call = deleteRecordValidateBeforeCall(entity, record, physical, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call deleteRecordAsync(String entity, String record, Boolean physical, final ApiCallback<GoldenDeleteResponseDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = deleteRecordValidateBeforeCall(entity, record, physical, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GoldenDeleteResponseDto>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call notifyRecordsCall(GoldenNotificationRequestDto body, String entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/golden/{entity}/notification"
            .replaceAll("\\{" + "entity" + "\\}", apiClient.escapeString(entity.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call notifyRecordsValidateBeforeCall(GoldenNotificationRequestDto body, String entity, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling notifyRecords(Async)");
        }
        // verify the required parameter 'entity' is set
        if (entity == null) {
            throw new ApiException("Missing the required parameter 'entity' when calling notifyRecords(Async)");
        }
        
        com.squareup.okhttp.Call call = notifyRecordsCall(body, entity, progressListener, progressRequestListener);
        return call;
    ...
    /**
     * Sends a notification for one or several records in an entity.
     * Searches golden records in the indicated entity using search conditions. For every found record, it re-creates a notification using the latest audited action for that record. If no auditing is available, notification will assume a record insertion. If the notification send flag is enable, actual notifications will be sent (or re-sent). The result contains all sent notifications.
     * @param body  (required)
     * @param entity Entity identifier (required)
     * @return GoldenNotificationResponseDto
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GoldenNotificationResponseDto notifyRecords(GoldenNotificationRequestDto body, String entity) throws ApiException {
        ApiResponse<GoldenNotificationResponseDto> resp = notifyRecordsWithHttpInfo(body, entity);
        return resp.getData();
    }
     ...
     * @param body  (required)
     * @param entity Entity identifier (required)
     * @return ApiResponse&lt;GoldenNotificationResponseDto&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GoldenNotificationResponseDto> notifyRecordsWithHttpInfo(GoldenNotificationRequestDto body, String entity) throws ApiException {
        com.squareup.okhttp.Call call = notifyRecordsValidateBeforeCall(body, entity, null, null);
        Type localVarReturnType = new TypeToken<GoldenNotificationResponseDto>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }

    /**
     * Sends a notification for one or several records in an entity. (asynchronously)
     * Searches golden records in the indicated entity using search conditions. For every found record, it re-creates a notification using the latest audited action for that record. If no auditing is available, notification will assume a record insertion. If the notification send flag is enable, actual notifications will be sent (or re-sent). The result contains all sent notifications.
     * @param body  (required)
     * @param entity Entity identifier (required)
     * @param callback The callback to be executed when the API call finishes
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call notifyRecordsAsync(GoldenNotificationRequestDto body, String entity, final ApiCallback<GoldenNotificationResponseDto> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = notifyRecordsValidateBeforeCall(body, entity, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GoldenNotificationResponseDto>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
     ...
     * Searches golden records considering indicated entity and search conditions.
     * @param body  (required)
     * @param entity Entity identifier (required)
