...
public class SecurityApi {
    ...
    /**
     * Authenticates an user using provided information - email and password.
     * Authenticates an user and generates a JWT bearer token if credentials match.
     * @param body Authentication dto containing username and raw password (required)
    ...
    /**
     * Authenticates an user using provided information - email and password. (asynchronously)
     * Authenticates an user and generates a JWT bearer token if credentials match.
     * @param body Authentication dto containing username and raw password (required)
