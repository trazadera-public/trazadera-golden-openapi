...
/**
 * Target locale. Used for parsing.
 */
@Schema(description = "Target locale. Used for parsing.")

public class ColumnTargetLocale {
  ...
  public ColumnTargetLocale language(String language) {
  ...
  **/
  ...
  public ColumnTargetLocale displayName(String displayName) {
  ...
  **/
  ...
  public ColumnTargetLocale country(String country) {
  ...
  **/
  ...
  public ColumnTargetLocale variant(String variant) {
  ...
  **/
  ...
  public ColumnTargetLocale script(String script) {
    this.script = script;
    return this;
  }
  ...
  **/
  ...
  public ColumnTargetLocale unicodeLocaleAttributes(List<String> unicodeLocaleAttributes) {
    this.unicodeLocaleAttributes = unicodeLocaleAttributes;
    return this;
  }

  public ColumnTargetLocale addUnicodeLocaleAttributesItem(String unicodeLocaleAttributesItem) {
  ...
  **/
  ...
  public ColumnTargetLocale unicodeLocaleKeys(List<String> unicodeLocaleKeys) {
    this.unicodeLocaleKeys = unicodeLocaleKeys;
    return this;
  }

  public ColumnTargetLocale addUnicodeLocaleKeysItem(String unicodeLocaleKeysItem) {
  ...
  **/
  ...
  public ColumnTargetLocale displayLanguage(String displayLanguage) {
  ...
  **/
  ...
  public ColumnTargetLocale displayScript(String displayScript) {
  ...
  **/
  ...
  public ColumnTargetLocale displayCountry(String displayCountry) {
  ...
  **/
  ...
  public ColumnTargetLocale displayVariant(String displayVariant) {
  ...
  **/
  ...
  public ColumnTargetLocale extensionKeys(List<String> extensionKeys) {
    this.extensionKeys = extensionKeys;
    return this;
  }

  public ColumnTargetLocale addExtensionKeysItem(String extensionKeysItem) {
  ...
  **/
  ...
  public ColumnTargetLocale iso3Language(String iso3Language) {
  ...
  **/
  ...
  public ColumnTargetLocale iso3Country(String iso3Country) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ColumnTargetLocale columnTargetLocale = (ColumnTargetLocale) o;
    return Objects.equals(this.language, columnTargetLocale.language) &&
        Objects.equals(this.displayName, columnTargetLocale.displayName) &&
        Objects.equals(this.country, columnTargetLocale.country) &&
        Objects.equals(this.variant, columnTargetLocale.variant) &&
        Objects.equals(this.script, columnTargetLocale.script) &&
        Objects.equals(this.unicodeLocaleAttributes, columnTargetLocale.unicodeLocaleAttributes) &&
        Objects.equals(this.unicodeLocaleKeys, columnTargetLocale.unicodeLocaleKeys) &&
        Objects.equals(this.displayLanguage, columnTargetLocale.displayLanguage) &&
        Objects.equals(this.displayScript, columnTargetLocale.displayScript) &&
        Objects.equals(this.displayCountry, columnTargetLocale.displayCountry) &&
        Objects.equals(this.displayVariant, columnTargetLocale.displayVariant) &&
        Objects.equals(this.extensionKeys, columnTargetLocale.extensionKeys) &&
        Objects.equals(this.iso3Language, columnTargetLocale.iso3Language) &&
        Objects.equals(this.iso3Country, columnTargetLocale.iso3Country);
  }
  ...
  public String toString() {
    ...
    sb.append("class ColumnTargetLocale {\n");
