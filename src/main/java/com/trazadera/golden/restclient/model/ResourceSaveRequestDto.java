...
/**
 * Represents a configuration object in JSON format.
 */
@Schema(description = "Represents a configuration object in JSON format.")
...
public class ResourceSaveRequestDto {
   ...
   * @return resource
  **/
  @Schema(description = "Resource in JSON format.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(resource, create, test);
  }
