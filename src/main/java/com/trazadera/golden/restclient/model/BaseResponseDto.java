...
/**
 * Base response DTO for Golden API.
 */
@Schema(description = "Base response DTO for Golden API.")
...
public class BaseResponseDto {
  ...
  public BaseResponseDto errors(List<String> errors) {
    this.errors = errors;
    return this;
  }

  public BaseResponseDto addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public BaseResponseDto messages(List<String> messages) {
    this.messages = messages;
    return this;
  }

  public BaseResponseDto addMessagesItem(String messagesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.errors, baseResponseDto.errors) &&
        Objects.equals(this.messages, baseResponseDto.messages);
  }
