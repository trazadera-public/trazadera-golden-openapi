...
import com.trazadera.golden.restclient.model.ColumnSourceLocale;
import com.trazadera.golden.restclient.model.ColumnTargetLocale;
...
public class Column {
  ...
  /**
   * Token type. Only meaningful if column is a token.
   */
  ...
  private ColumnSourceLocale sourceLocale = null;

  @SerializedName("target")
  private String target = null;

  @SerializedName("targetLocale")
  private ColumnTargetLocale targetLocale = null;
  ...
  **/
   ...
   * @return token
  **/
  @Schema(description = "Token type. Only meaningful if column is a token.")
  ...
  **/
  ...
  public Column source(String source) {
   ...
   /**
   * Source format. Used for parsing.
   * @return source
  **/
  @Schema(description = "Source format. Used for parsing.")
  ...
  public Column sourceLocale(ColumnSourceLocale sourceLocale) {
  ...
  **/
  @Schema(description = "")
  public ColumnSourceLocale getSourceLocale() {
    return sourceLocale;
  }

  public void setSourceLocale(ColumnSourceLocale sourceLocale) {
    this.sourceLocale = sourceLocale;
  }

  public Column target(String target) {
    this.target = target;
    return this;
  }

   /**
   * Target format. Used for parsing.
   * @return target
  **/
  @Schema(description = "Target format. Used for parsing.")
  ...
  public Column targetLocale(ColumnTargetLocale targetLocale) {
  ...
  **/
  @Schema(description = "")
  public ColumnTargetLocale getTargetLocale() {
    return targetLocale;
  }

  public void setTargetLocale(ColumnTargetLocale targetLocale) {
    this.targetLocale = targetLocale;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.type, column.type) &&
        ...
        Objects.equals(this.target, column.target) &&
        Objects.equals(this.targetLocale, column.targetLocale) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, token, dataset, key, description, array, empty, error, errorReplacement, validation, source, sourceLocale, target, targetLocale, regex, script);
  }
