...
public class EntityDto {
  ...
  **/
  ...
  public EntityDto eventType(EventTypeEnum eventType) {
   ...
   * @return eventType
  **/
  @Schema(description = "Entity event type.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, entityDto.id) &&
        ...
        Objects.equals(this.eventType, entityDto.eventType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, description, locked, automatic, status, dataset, table, type, searches, duplicates, indexer, classifier, merger, pipeline, steward, lastUpdated, recordCount, bucketCount, duplicateBucketCount, indexDuplicateCounts, indexLabels, events, eventSink, eventType);
  }
