 ...
 * Represents an user
 */
@Schema(description = "Represents an user")
...
public class UserResponseDto {
  ...
  **/
  ...
  public UserResponseDto errors(List<String> errors) {
    this.errors = errors;
    return this;
  }

  public UserResponseDto addErrorsItem(String errorsItem) {
    if (this.errors == null) {
  ...
  **/
  ...
  public UserResponseDto messages(List<String> messages) {
    this.messages = messages;
    return this;
  }

  public UserResponseDto addMessagesItem(String messagesItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.user, userResponseDto.user) &&
        Objects.equals(this.errors, userResponseDto.errors) &&
        Objects.equals(this.messages, userResponseDto.messages);
  }

  @Override
  public int hashCode() {
    return Objects.hash(user, errors, messages);
  }
